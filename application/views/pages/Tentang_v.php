      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="slide-head-text text-center">
            <h3 class="wow fadeInDown"><span><?php echo get_phrase('Tentang Kami') ?></span></h3>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <?php foreach ($tentang->result() as $result) : ?>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 wow fadeInLeft">
            <div class="well-middle">
              <div class="single-well">
                <a href="#">
                  <h2 class="sec-head"><span><?php echo $result->nama_tentang ?></span></h2>
                </a>
                <p>
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 wow fadeInLeft d-none">
            <div class="well-middle">
              <div class="single-well">
                <a href="#">
                  <h2 class="sec-head"><span><?php echo get_phrase('Komitmen Kami') ?></span></h2>
                </a>
                <p>
                  <?php if ($this->session->userdata('current_language') == 'English') { ?>
                    <?php echo $result->our_commitment_en ?>
                  <?php } else { ?>
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 wow fadeInLeft d-none">
            <div class="well-middle">
              <div class="single-well">
                <a href="#">
                  <h2 class="sec-head"><span><?php echo get_phrase('Visi & Misi') ?></span></h2>
                </a>
                <p>
                  <?php if ($this->session->userdata('current_language') == 'English') { ?>
                    <?php echo $result->vision_mission_en ?>
                  <?php } else { ?>
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 wow fadeInLeft d-none">
            <div class="well-middle">
              <div class="single-well">
                <a href="#">
                  <h2 class="sec-head"><span><?php echo get_phrase('Pasar Utama') ?></span></h2>
                </a>
                <p>
                  <?php if ($this->session->userdata('current_language') == 'English') { ?>
                    <?php echo $result->main_market_en ?>
                  <?php } else { ?>
